        ...
        prepared_requests.append(
            {
                **request,
                ...
                "miss_reason_detail": source_evaluation.get("miss_reason_detail"),
                "miss_diagnostics": list(source_evaluation.get("miss_diagnostics") or []),
                "source_candidate_pool_status": source_evaluation.get("source_candidate_pool_status"),
                ...
                "source_event_contract_status": source_evaluation.get("source_event_contract_status"),
                "source_artifact_status": source_evaluation.get("source_artifact_status"),
